...
describe 'Arbitrary WorkPackage query table widget dashboard', type: :feature, js: true do
  ...
  context 'with the permission to save queries' do
    it 'can add the widget and see the work packages of the filtered for types' do
      ...
      dashboard_page.add_widget(2, 3, "Work packages")
      ...
      modal = ::Components::WorkPackages::TableConfigurationModal.new(filter_area.area)
      ...
      columns = ::Components::WorkPackages::Columns.new(filter_area.area)
  ...
  context 'without the permission to save queries' do
    ...
    it 'cannot add the widget' do
      ...
      dashboard_page.expect_unable_to_add_widget(2, 3, "Work packages")
    end
  end
end
